    ...
    <div class="panel panel-danger">
      ...
      <div id="collapse1" class="panel-collapse collapse">
        <div class="panel-body">
          <h1>MARS</h1>
			<p>Mars is the fourth planet from the Sun and is the second smallest planet in the solar system. Named after the Roman god of war, Mars is also often described as the “Red Planet” due to its reddish appearance. Mars is a terrestrial planet with a thin atmosphere composed primarily of carbon dioxide.</p>

			<h4>Mars Planet Profile
			...
			Recorded By:	Egyptian astronomers </h4>
			<br>
			<h4>Mars takes its name from the Roman god of war.</h4>
      ...
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body">
          <h1>Facts About Mars</h1>
			<h4>Mars and Earth have approximately the same landmass.</h4>
			...
			<h4>Mars is home to the tallest mountain in the solar system.</h4>
			...
			Only 18 missions to Mars have been successful.</p>
...
<div class="col-md-4">
      ...
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-footer">
          <h4>Mars has the largest dust storms in the solar system.</h4>
			<p>They can last for months and cover the entire planet. The seasons are extreme because its elliptical (oval-shaped) orbital path around the Sun is more elongated than most other planets in the solar system.
			On Mars the Sun appears about half the size as it does on Earth.</p>
			...
			<h4>Pieces of Mars have fallen to Earth.</h4>
...
<div class="col-md-12">
      <div class="thumbnail">
          <a href="/images/mars3.jpg">
          <img src="/images/mars3.jpg" alt="mars3" style="width:90%; height:700px"></a>
          <div class="caption">
              <p>Mars</p>
          </div>
          </a>
...
<div class="col-md-6">
      <div class="thumbnail">
          <a href="/images/mars2.jpg">
          <img src="/images/mars2.jpg" alt="mars2" style="width:90%; height:600px"></a>
          <div class="caption">
              <p>Mars</p>
          </div>
          </a>
 ...
 <div class="col-md-6">
      <div class="thumbnail">
          ...
          <img src="/images/mars.jpg" alt="mars" style="width:90%; height:600px"></a>
          <div class="caption">
              <p>Mars</p>
          </div>
          </a>
